...
import static org.jboss.as.controller.operations.global.ReadFeatureDescriptionHandler.ADDRESS_PARAMETERS;
import static org.jboss.as.controller.operations.global.ReadFeatureDescriptionHandler.FEATURE_ID;
import static org.jboss.as.controller.operations.global.ReadFeatureDescriptionHandler.OPERATION_PARAMETERS;
import static org.jboss.as.controller.operations.global.ReadFeatureDescriptionHandler.OPERATION_PARAMETERS_MAPPING;
import static org.jboss.as.controller.operations.global.ReadFeatureDescriptionHandler.PARAMETERS;
import static org.jboss.as.controller.operations.global.ReadFeatureDescriptionHandler.REFERENCES;
...
public class ReadFeatureDescriptionTestCase extends AbstractControllerTestBase {
    ...
    public void testStorageResource() throws OperationFailedException {
        ...
        assertSortedArrayEquals(new String[] {"optional-attr", "mandatory-attr"}, annotation.require(OPERATION_PARAMETERS).asString().split(","));
...
//        Assert.assertTrue(params.containsKey("mandatory-attr"));
        ...
        Assert.assertArrayEquals(new String[] {SUBSYSTEM, RESOURCE}, annotation.require(ADDRESS_PARAMETERS).asString().split(","));
        assertSortedArrayEquals(new String[] {"optional-attr"}, annotation.require(OPERATION_PARAMETERS).asString().split(","));
        Assert.assertEquals("subsystem.testsubsystem.resource.main-resource", listAttr.require("refs").asList().get(0).require(FEATURE).asString());
    ...
    private Map<String, ModelNode> extractParamsToMap(ModelNode feature) {
        return extractToMap(feature.require(PARAMETERS), NAME);
    }

    private Map<String, ModelNode> extractRefsToMap(ModelNode feature) {
        return extractToMap(feature.require(REFERENCES), FEATURE);
    }
